  ...
  return (
    <div className="bg-gray-50 max-w-[1450px] mx-auto">
      <div className="max-w-3xl mx-auto px-4 py-10 min-h-[60vh]">
        ...
        <p className="text-gray-600 mb-8">We want you to be happy with your purchase. This policy explains when and how you can request a return or a replacement on brandstored.com.</p>
        ...
        <div className="space-y-6 bg-white border border-gray-200 rounded-xl p-6">
          ...
          <section>
            ...
            <p className="text-gray-700">Need help? Email <a href="mailto:support@brandstored.com" className="text-orange-600 underline">support@brandstored.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
